<div wire:ignore.self class="modal fade" id="tambah-kategori" tabindex="-1" role="dialog"
    aria-labelledby="tambah-kategoriLabel" aria-hidden="true">
    <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content">
            <div class="modal-header" style="background-color: #007bff">
                <h5 class="modal-title text-light" id="tambah-kategoriLabel">
                ...
                <div class="table-responsive">
                    <table class="table table-hover">
                        <tr>
                            ...
                            <td>
                                <input wire:model.live="nama_kategori" type="text"
                                    class="form-control
